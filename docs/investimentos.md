...
3. Em **Movimentações**, **Nova** abre primeiro a escolha entre compra e venda. Em seguida, selecione a corretora. Na compra, o campo **Ativo** lista o tipo (Ações, FIIs, Stocks, BDRs, ETFs, ETFs Internacionais, REITs, Criptomoedas, Renda Fixa, Tesouro Direto, Fundos de Investimentos e Outros). Informe o código: tickers da B3 preenchem nome, setor e preço unitário automaticamente (o preço pode ser ajustado); códigos já cadastrados são encontrados na carteira; CDB, Tesouro, cripto e demais códigos são cadastrados na hora a partir do tipo escolhido. Vendas aceitam somente ativos com quantidade em carteira; a lista da carteira também permite escolher o ativo. Informe data, quantidade, preço por unidade e taxas. As datas podem ser retroativas, até o dia atual.

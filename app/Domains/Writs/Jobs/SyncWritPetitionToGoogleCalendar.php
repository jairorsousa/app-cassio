...
class SyncWritPetitionToGoogleCalendar implements ShouldQueue
{
    ...
    public function handle(GoogleCalendarService $googleCalendar): void
    {
        ...
        $googleCalendar->syncWritPetition($writ);
    }
    ...
    public function failed(Throwable $exception): void
    {
        Writ::query()
            ...
            ->update([
                'google_calendar_petition_sync_error' => Str::limit($exception->getMessage(), 2000, ''),
            ]);
    }
}
